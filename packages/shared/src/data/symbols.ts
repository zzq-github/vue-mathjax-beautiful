...
export const basicSymbols: Symbol[] = [
  ...
  { latex: '\\lt', description: { 'zh-CN': '小于', 'en-US': 'Less Than' }, display: '' },
  { latex: '\\gt', description: { 'zh-CN': '大于', 'en-US': 'Greater Than' }, display: '' },
  ...
  {
    latex: '\\sqrt{x}',
    description: { 'zh-CN': '根号x', 'en-US': 'Square Root of x' },
    display: '',
  },
  ...
  {
    latex: '\\frac{1}{x^2}',
    description: { 'zh-CN': '平方倒数', 'en-US': 'Square Reciprocal' },
    display: '',
  },
  {
    latex: '\\frac{x^2}{y^2}',
    description: { 'zh-CN': '平方分数', 'en-US': 'Square Fraction' },
    display: '',
  },
  ...
  {
    latex: '\\int_{a}^{b}',
    description: { 'zh-CN': '定积分', 'en-US': 'Definite Integral' },
    display: '',
  },
  {
    latex: '\\int_{a}^{b} f(x) dx',
    description: { 'zh-CN': '定积分完整形式', 'en-US': 'Complete Definite Integral' },
    display: '',
  },
  ...
  {
    latex: '\\sum_{i=1}^{n}',
    description: { 'zh-CN': '求和1到n', 'en-US': 'Sum from 1 to n' },
    display: '',
  },
  {
    latex: '\\sum_{i=0}^{\\infty}',
    description: { 'zh-CN': '无穷求和', 'en-US': 'Infinite Sum' },
    display: '',
  },
  { latex: '\\prod', description: { 'zh-CN': '连乘', 'en-US': 'Product' }, display: '' },
  {
    latex: '\\prod_{i=1}^{n}',
    description: { 'zh-CN': '乘积1到n', 'en-US': 'Product from 1 to n' },
    display: '',
  },
  ...
  { latex: '\\frac{dx}{dy}', description: { 'zh-CN': '导数', 'en-US': 'Derivative' }, display: '' },
  {
    ...
    description: { 'zh-CN': '偏导数', 'en-US': 'Partial Derivative' },
    display: '',
  },
  {
    latex: "f'(x)",
    description: { 'zh-CN': '导数符号', 'en-US': 'Derivative Notation' },
    display: '',
  },
  {
    latex: 'f^{(n)}(x)',
    description: { 'zh-CN': 'n阶导数', 'en-US': 'nth Derivative' },
    display: '',
  },
  {
    latex: '\\partial',
    description: { 'zh-CN': '偏导符号', 'en-US': 'Partial Symbol' },
    display: '',
  },
  ...
  {
    latex: '\\lim_{x \\to a}',
    description: { 'zh-CN': '极限x趋于a', 'en-US': 'Limit x approaches a' },
    display: '',
  },
  {
    latex: '\\lim_{x \\to \\infty}',
    description: { 'zh-CN': '无穷极限', 'en-US': 'Infinite Limit' },
    display: '',
  },
  {
    latex: '\\lim_{x \\to 0^+}',
    description: { 'zh-CN': '右极限', 'en-US': 'Right Limit' },
    display: '',
  },
  {
    latex: '\\lim_{x \\to 0^-}',
    description: { 'zh-CN': '左极限', 'en-US': 'Left Limit' },
    display: '',
  },
  ...
  {
    latex: '\\log_a b',
    description: { 'zh-CN': '以a为底的对数', 'en-US': 'Log base a of b' },
    display: '',
  },
  { latex: '\\log_{10}', description: { 'zh-CN': '常用对数', 'en-US': 'Common Log' }, display: '' },
  {
    latex: 'e^x',
    description: { 'zh-CN': '自然指数', 'en-US': 'Natural Exponential' },
    display: '',
  },
  {
    latex: 'a^{bc}',
    description: { 'zh-CN': '复合指数', 'en-US': 'Compound Exponent' },
    display: '',
  },
  {
    latex: '\\exp',
    description: { 'zh-CN': '指数函数', 'en-US': 'Exponential Function' },
    display: '',
  },
  ...
  { latex: '\\overline{AB}', description: { 'zh-CN': '上划线', 'en-US': 'Overline' }, display: '' },
  {
    ...
    description: { 'zh-CN': '向量AB', 'en-US': 'Vector AB' },
    display: '',
  },
  ...
  // 英文字母
  // { latex: 'a', description: { 'zh-CN': '字母a', 'en-US': 'Letter a' }, display: '' },
  // { latex: 'b', description: { 'zh-CN': '字母b', 'en-US': 'Letter b' }, display: '' },
  // { latex: 'c', description: { 'zh-CN': '字母c', 'en-US': 'Letter c' }, display: '' },
  // { latex: 'd', description: { 'zh-CN': '字母d', 'en-US': 'Letter d' }, display: '' },
  // { latex: 'e', description: { 'zh-CN': '字母e', 'en-US': 'Letter e' }, display: '' },
  // { latex: 'f', description: { 'zh-CN': '字母f', 'en-US': 'Letter f' }, display: '' },
  // { latex: 'g', description: { 'zh-CN': '字母g', 'en-US': 'Letter g' }, display: '' },
  // { latex: 'h', description: { 'zh-CN': '字母h', 'en-US': 'Letter h' }, display: '' },
  // { latex: 'i', description: { 'zh-CN': '字母i', 'en-US': 'Letter i' }, display: '' },
  // { latex: 'j', description: { 'zh-CN': '字母j', 'en-US': 'Letter j' }, display: '' },
  // { latex: 'k', description: { 'zh-CN': '字母k', 'en-US': 'Letter k' }, display: '' },
  // { latex: 'l', description: { 'zh-CN': '字母l', 'en-US': 'Letter l' }, display: '' },
  // { latex: 'm', description: { 'zh-CN': '字母m', 'en-US': 'Letter m' }, display: '' },
  // { latex: 'n', description: { 'zh-CN': '字母n', 'en-US': 'Letter n' }, display: '' },
  // { latex: 'o', description: { 'zh-CN': '字母o', 'en-US': 'Letter o' }, display: '' },
  // { latex: 'p', description: { 'zh-CN': '字母p', 'en-US': 'Letter p' }, display: '' },
  // { latex: 'q', description: { 'zh-CN': '字母q', 'en-US': 'Letter q' }, display: '' },
  // { latex: 'r', description: { 'zh-CN': '字母r', 'en-US': 'Letter r' }, display: '' },
  // { latex: 's', description: { 'zh-CN': '字母s', 'en-US': 'Letter s' }, display: '' },
  // { latex: 't', description: { 'zh-CN': '字母t', 'en-US': 'Letter t' }, display: '' },
  // { latex: 'u', description: { 'zh-CN': '字母u', 'en-US': 'Letter u' }, display: '' },
  // { latex: 'v', description: { 'zh-CN': '字母v', 'en-US': 'Letter v' }, display: '' },
  // { latex: 'w', description: { 'zh-CN': '字母w', 'en-US': 'Letter w' }, display: '' },
  // { latex: 'x', description: { 'zh-CN': '字母x', 'en-US': 'Letter x' }, display: '' },
  // { latex: 'y', description: { 'zh-CN': '字母y', 'en-US': 'Letter y' }, display: '' },
  // { latex: 'z', description: { 'zh-CN': '字母z', 'en-US': 'Letter z' }, display: '' },
...
export const greekSymbols: Symbol[] = [
  ...
  {
    latex: '\\varepsilon',
    description: { 'zh-CN': '爱普西隆变体', 'en-US': 'Var Epsilon' },
    display: '',
  },
  ...
  {
    latex: '\\varsigma',
    description: { 'zh-CN': '西格马尾字母', 'en-US': 'Final Sigma' },
    display: '',
  },
  ...
  {
    latex: 'A',
    description: { 'zh-CN': '阿尔法 (大写)', 'en-US': 'Alpha (Uppercase)' },
    display: '',
  },
  { latex: 'B', description: { 'zh-CN': '贝塔 (大写)', 'en-US': 'Beta (Uppercase)' }, display: '' },
  {
    latex: '\\Gamma',
    description: { 'zh-CN': '伽马 (大写)', 'en-US': 'Gamma (Uppercase)' },
    display: '',
  },
  {
    latex: '\\Delta',
    description: { 'zh-CN': '德尔塔 (大写)', 'en-US': 'Delta (Uppercase)' },
    display: '',
  },
  {
    latex: 'E',
    description: { 'zh-CN': '爱普西隆 (大写)', 'en-US': 'Epsilon (Uppercase)' },
    display: '',
  },
  ...
  {
    latex: '\\Theta',
    description: { 'zh-CN': '西塔 (大写)', 'en-US': 'Theta (Uppercase)' },
    display: '',
  },
  { latex: 'I', description: { 'zh-CN': '约塔 (大写)', 'en-US': 'Iota (Uppercase)' }, display: '' },
  {
    latex: 'K',
    description: { 'zh-CN': '卡帕 (大写)', 'en-US': 'Kappa (Uppercase)' },
    display: '',
  },
  ...
  {
    latex: '\\Lambda',
    description: { 'zh-CN': '兰布达 (大写)', 'en-US': 'Lambda (Uppercase)' },
    display: '',
  },
  ...
  {
    latex: '\\Xi',
    description: { 'zh-CN': '克西 (大写)', 'en-US': 'Xi (Uppercase)' },
    display: '',
  },
  {
    latex: 'O',
    description: { 'zh-CN': '欧米克隆 (大写)', 'en-US': 'Omicron (Uppercase)' },
    display: '',
  },
  ...
  {
    latex: '\\Sigma',
    description: { 'zh-CN': '西格马 (大写)', 'en-US': 'Sigma (Uppercase)' },
    display: '',
  },
  { latex: 'T', description: { 'zh-CN': '陶 (大写)', 'en-US': 'Tau (Uppercase)' }, display: '' },
  {
    latex: '\\Upsilon',
    description: { 'zh-CN': '厄普西隆 (大写)', 'en-US': 'Upsilon (Uppercase)' },
    display: '',
  },
  ...
  {
    latex: '\\Phi',
    description: { 'zh-CN': '斐 (大写)', 'en-US': 'Phi (Uppercase)' },
    display: '',
  },
  { latex: 'X', description: { 'zh-CN': '卡 (大写)', 'en-US': 'Chi (Uppercase)' }, display: '' },
  {
    latex: '\\Psi',
    description: { 'zh-CN': '普西 (大写)', 'en-US': 'Psi (Uppercase)' },
    display: '',
  },
  {
    latex: '\\Omega',
    description: { 'zh-CN': '欧米伽 (大写)', 'en-US': 'Omega (Uppercase)' },
    display: '',
  },
];
...
export const advancedSymbols: Symbol[] = [
  ...
  {
    latex: '\\subseteq',
    description: { 'zh-CN': '子集或相等', 'en-US': 'Subset or Equal' },
    display: '',
  },
  {
    latex: '\\supseteq',
    description: { 'zh-CN': '超集或相等', 'en-US': 'Superset or Equal' },
    display: '',
  },
  ...
  {
    latex: '\\setminus',
    description: { 'zh-CN': '集合差', 'en-US': 'Set Difference' },
    display: '',
  },
  ...
  {
    latex: '\\mathbb{N}',
    description: { 'zh-CN': '自然数集', 'en-US': 'Natural Numbers' },
    display: '',
  },
  { latex: '\\mathbb{Z}', description: { 'zh-CN': '整数集', 'en-US': 'Integers' }, display: '' },
  {
    latex: '\\mathbb{Q}',
    description: { 'zh-CN': '有理数集', 'en-US': 'Rational Numbers' },
    display: '',
  },
  {
    latex: '\\mathbb{R}',
    description: { 'zh-CN': '实数集', 'en-US': 'Real Numbers' },
    display: '',
  },
  {
    latex: '\\mathbb{C}',
    description: { 'zh-CN': '复数集', 'en-US': 'Complex Numbers' },
    display: '',
  },
  {
    latex: '\\mathbb{P}',
    description: { 'zh-CN': '素数集', 'en-US': 'Prime Numbers' },
    display: '',
  },
  { latex: '\\aleph', description: { 'zh-CN': 'Aleph', 'en-US': 'Aleph' }, display: '' },
  {
    latex: '\\hbar',
    description: { 'zh-CN': '约化普朗克常数', 'en-US': 'Reduced Planck Constant' },
    display: '',
  },
  { latex: '\\ell', description: { 'zh-CN': '脚本L', 'en-US': 'Script L' }, display: '' },
  {
    latex: '\\wp',
    description: { 'zh-CN': 'Weierstrass P', 'en-US': 'Weierstrass P' },
    display: '',
  },
  ...
  {
    latex: '\\iint',
    description: { 'zh-CN': '二重积分', 'en-US': 'Double Integral' },
    display: '',
  },
  {
    latex: '\\iiint',
    description: { 'zh-CN': '三重积分', 'en-US': 'Triple Integral' },
    display: '',
  },
  { latex: '\\oint', description: { 'zh-CN': '环积分', 'en-US': 'Contour Integral' }, display: '' },
  {
  ...
  {
    latex: '\\simeq',
    description: { 'zh-CN': '渐近相等', 'en-US': 'Asymptotically Equal' },
    display: '',
  },
  ...
  {
    latex: '\\rightarrow',
    description: { 'zh-CN': '右箭头', 'en-US': 'Right Arrow' },
    display: '',
  },
  { latex: '\\leftarrow', description: { 'zh-CN': '左箭头', 'en-US': 'Left Arrow' }, display: '' },
  {
    latex: '\\leftrightarrow',
    description: { 'zh-CN': '双向箭头', 'en-US': 'Bidirectional Arrow' },
    display: '',
  },
  { latex: '\\Rightarrow', description: { 'zh-CN': '蕴含', 'en-US': 'Implies' }, display: '' },
  {
    latex: '\\Leftarrow',
    description: { 'zh-CN': '被蕴含', 'en-US': 'Is Implied By' },
    display: '',
  },
  {
    latex: '\\Leftrightarrow',
    description: { 'zh-CN': '当且仅当', 'en-US': 'If and Only If' },
    display: '',
  },
  ...
  {
    latex: '\\updownarrow',
    description: { 'zh-CN': '上下箭头', 'en-US': 'Up Down Arrow' },
    display: '',
  },
  {
    latex: '\\nearrow',
    description: { 'zh-CN': '东北箭头', 'en-US': 'Northeast Arrow' },
    display: '',
  },
  ...
  {
    latex: '\\ominus',
    description: { 'zh-CN': '对称差', 'en-US': 'Symmetric Difference' },
    display: '',
  },
  ...
  { latex: '\\perp', description: { 'zh-CN': '垂直', 'en-US': 'Perpendicular' }, display: '' },
  {
    ...
    description: { 'zh-CN': '球面角', 'en-US': 'Spherical Angle' },
    display: '',
  },
  {
    latex: '\\measuredangle',
    description: { 'zh-CN': '测量角', 'en-US': 'Measured Angle' },
    display: '',
  },
  ...
  {
    latex: '\\varnothing',
    description: { 'zh-CN': '空集变体', 'en-US': 'Empty Set Variant' },
    display: '',
  },
  ...
  {
    latex: '\\diamondsuit',
    description: { 'zh-CN': '方块', 'en-US': 'Diamond Suit' },
    display: '',
  },
