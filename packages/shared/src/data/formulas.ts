...
export const formulaExamples: Symbol[] = [
  ...
  {
    latex: 'x^2 + y^2 = z^2',
    description: { 'zh-CN': '勾股定理', 'en-US': 'Pythagorean Theorem' },
    display: '',
  },
  {
    latex: '(a + b)^2 = a^2 + 2ab + b^2',
    description: { 'zh-CN': '完全平方公式', 'en-US': 'Perfect Square Formula' },
    display: '',
  },
  {
    latex: '(a - b)^2 = a^2 - 2ab + b^2',
    description: { 'zh-CN': '完全平方差公式', 'en-US': 'Perfect Square Difference' },
    display: '',
  },
  {
    latex: 'a^2 - b^2 = (a + b)(a - b)',
    description: { 'zh-CN': '平方差公式', 'en-US': 'Difference of Squares' },
    display: '',
  },
  ...
  {
    latex: '\\sqrt{a^2 + b^2}',
    description: { 'zh-CN': '平方根公式', 'en-US': 'Square Root Formula' },
    display: '',
  },
  {
    latex: '\\sqrt{ab} = \\sqrt{a} \\cdot \\sqrt{b}',
    description: { 'zh-CN': '根式乘法', 'en-US': 'Radical Multiplication' },
    display: '',
  },
  {
    latex: '\\sqrt[n]{a^m} = a^{\\frac{m}{n}}',
    description: { 'zh-CN': '根式指数化', 'en-US': 'Radical to Exponent' },
    display: '',
  },
  ...
  // 指数对数公式
  {
    ...
    description: { 'zh-CN': '同底数幂相乘', 'en-US': 'Product of Powers' },
    display: '',
  },
  {
    latex: '\\frac{a^m}{a^n} = a^{m-n}',
    description: { 'zh-CN': '同底数幂相除', 'en-US': 'Quotient of Powers' },
    display: '',
  },
  {
    latex: '(a^m)^n = a^{mn}',
    description: { 'zh-CN': '幂的乘方', 'en-US': 'Power of a Power' },
    display: '',
  },
  {
    latex: '\\log_a(xy) = \\log_a x + \\log_a y',
    description: { 'zh-CN': '对数乘法法则', 'en-US': 'Logarithm Product Rule' },
    display: '',
  },
  {
  ...
  // 三角函数公式
  {
    ...
    description: { 'zh-CN': '三角恒等式', 'en-US': 'Trigonometric Identity' },
    display: '',
  },
  {
  ...
  },
  {
    ...
    description: { 'zh-CN': '正切定义', 'en-US': 'Tangent Definition' },
    display: '',
  },
  ...
  },
  {
    ...
    description: { 'zh-CN': '幂函数导数', 'en-US': 'Power Rule' },
    display: '',
  },
  {
    latex: '\\int x^n dx = \\frac{x^{n+1}}{n+1} + C',
    description: { 'zh-CN': '幂函数积分', 'en-US': 'Power Rule Integration' },
    display: '',
  },
  {
  ...
  // 数列公式
  {
    ...
    description: { 'zh-CN': '等差数列求和', 'en-US': 'Arithmetic Series Sum' },
    display: '',
  },
  {
  ...
  },
  {
    ...
    description: { 'zh-CN': '等比数列求和', 'en-US': 'Geometric Series Sum' },
    display: '',
  },
  ...
  // 概率统计公式
  {
    ...
    description: { 'zh-CN': '概率加法公式', 'en-US': 'Probability Addition Rule' },
    display: '',
  },
  {
    latex: 'C_n^r = \\frac{n!}{r!(n-r)!}',
    description: { 'zh-CN': '组合数公式', 'en-US': 'Combination Formula' },
    display: '',
  },
  {
    latex: '\\bar{x} = \\frac{1}{n}\\sum_{i=1}^{n} x_i',
    description: { 'zh-CN': '算术平均数', 'en-US': 'Arithmetic Mean' },
    display: '',
  },
  ...
  {
    latex: 'A = \\pi r^2',
    description: { 'zh-CN': '圆面积公式', 'en-US': 'Circle Area Formula' },
    display: '',
  },
  {
    latex: 'V = \\frac{4}{3}\\pi r^3',
    description: { 'zh-CN': '球体积公式', 'en-US': 'Sphere Volume Formula' },
    display: '',
  },
  {
    latex: 'c^2 = a^2 + b^2 - 2ab\\cos C',
    description: { 'zh-CN': '余弦定理', 'en-US': 'Law of Cosines' },
    display: '',
  },
  ...
  {
    latex: 'e^{i\\pi} + 1 = 0',
    description: { 'zh-CN': '欧拉公式', 'en-US': "Euler's Formula" },
    display: '',
  },
  {
