<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 relative overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden">
      ...
      <!-- 数学符号装饰 -->
      <div class="absolute top-20 left-10 text-blue-300/20 dark:text-blue-400/20 text-8xl font-bold select-none rotate-12">
        ∫
      </div>
      <div class="absolute bottom-32 right-20 text-purple-300/20 dark:text-purple-400/20 text-6xl font-bold select-none -rotate-12">
        ∂
      </div>
      <div class="absolute top-1/3 right-10 text-indigo-300/20 dark:text-indigo-400/20 text-5xl font-bold select-none rotate-45">
        ∑
      </div>
      <div class="absolute bottom-1/3 left-20 text-cyan-300/20 dark:text-cyan-400/20 text-4xl font-bold select-none -rotate-45">
        √
      </div>
      <div class="absolute top-2/3 left-1/4 text-blue-200/20 dark:text-blue-300/20 text-3xl font-bold select-none rotate-12">
        π
      </div>
      <div class="absolute top-1/4 right-1/3 text-purple-200/20 dark:text-purple-300/20 text-4xl font-bold select-none -rotate-12">
        Σ
      </div>
