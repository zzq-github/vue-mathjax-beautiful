<template>
  <section
    id="docs"
    class="py-20 relative min-h-screen"
  >
      ...
      <div class="grid gap-8 lg:grid-cols-12 relative items-start">
        ...
        <div class="col-span-12 order-2 lg:order-1 lg:pr-20">
          <div class="grid gap-8 lg:grid-cols-1">
            ...
            <div
              id="install"
              class="lg:col-span-2 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 shadow-xl border border-gray-200/50 dark:border-gray-700/50 transition-colors duration-300"
            >
              ...
              <div class="grid md:grid-cols-2 gap-6">
                <!-- 包管理器安装 -->
                <div class="space-y-4">
                  <h4 class="font-semibold text-blue-800 dark:text-blue-300 text-base mb-4">
                    {{ t('docs.sections.installation.packageManagers') }}
                  </h4>
                ...
                <div class="space-y-4">
                  <h4 class="font-semibold text-blue-800 dark:text-blue-300 text-base mb-4">
                    {{ t('docs.sections.installation.requirements') }}
                  </h4>
                  ...
                  <div>
                    ...
                    <div class="bg-gray-900/90 dark:bg-gray-950/90 backdrop-blur-sm text-gray-100 dark:text-gray-200 p-3 rounded-lg font-mono text-xs transition-colors duration-300 border border-gray-700/50">
                      <div class="text-green-400">
                        &lt;script src="https://unpkg.com/vue-mathjax-beautiful"&gt;&lt;/script&gt;
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="bg-white/80 dark:bg-gray-900/40 backdrop-blur-sm text-gray-700 dark:text-gray-200 p-4 rounded-lg text-xs transition-colors duration-300 border border-gray-200/60 dark:border-gray-700/60 space-y-2">
                      <p class="text-gray-600 dark:text-gray-300">
                        {{ t('docs.sections.installation.localMathjaxDesc') }}
                      </p>
                      ...
                      <p class="text-[11px] text-amber-600 dark:text-amber-300">
                        {{ t('docs.sections.installation.localMathjaxTip') }}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div
              id="basicUsage"
              class="lg:col-span-2 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 shadow-xl border border-gray-200/50 dark:border-gray-700/50 transition-colors duration-300"
            >
              <h3 class="flex items-center gap-3 text-lg font-semibold text-gray-900 dark:text-white mb-6 transition-colors duration-300">
              ...
              <div class="space-y-6">
                <!-- Vue 3 组合式API示例 -->
                <div>
                  <h4 class="font-semibold text-green-800 dark:text-green-300 mb-3 text-base">
                    {{ t('docs.sections.integrationExample.composition') }}
                  </h4>
                  <div class="bg-gray-900/90 dark:bg-gray-950/90 backdrop-blur-sm text-gray-100 dark:text-gray-200 p-4 rounded-xl font-mono text-sm transition-colors duration-300 border border-gray-700/50 overflow-x-auto">
                    ...
                    <div class="ml-6 text-yellow-400">
                ...
                <div>
                  <h4 class="font-semibold text-green-800 dark:text-green-300 mb-3 text-base">
                    {{ t('docs.sections.integrationExample.scriptSetup') }}
                  </h4>
                  <div class="bg-gray-900/90 dark:bg-gray-950/90 backdrop-blur-sm text-gray-100 dark:text-gray-200 p-4 rounded-xl font-mono text-sm transition-colors duration-300 border border-gray-700/50 overflow-x-auto">
                    <div class="text-blue-400">
                ...
                <div>
                  <h4 class="font-semibold text-green-800 dark:text-green-300 mb-3 text-base">
                    {{ t('docs.sections.integrationExample.utilityFunctions') }}
                  </h4>
                  <div class="bg-gray-900/90 dark:bg-gray-950/90 backdrop-blur-sm text-gray-100 dark:text-gray-200 p-4 rounded-xl font-mono text-sm transition-colors duration-300 border border-gray-700/50 overflow-x-auto">
                    <div class="text-gray-400">
                      // 检测和处理LaTeX公式
                    ...
                    <div class="text-purple-400">
                      import { matchLatex, hasLatexFormula, convertLatexToSvg } from 'vue-mathjax-beautiful'
                    </div>
                    <br>
                    <div class="text-white">
                    ...
                    <div class="ml-2 text-white">
                      const matches = matchLatex(text)
                    </div>
                    <div class="ml-2 text-white">
                      matches.forEach(match => {
                    </div>
                    <div class="ml-4 text-white">
                      console.log('公式:', match.content)
                    </div>
                    <div class="ml-4 text-white">
                      console.log('类型:', match.isInline ? '行内' : '块级')
                    </div>
                    <div class="ml-2 text-white">
                      })
                    </div>
                    ...
                    <div class="ml-2 text-white">
                      const svgResult = await convertLatexToSvg('E=mc^2')
                    </div>
                    <div class="text-white">
                      }
                    </div>
                ...
                <div>
                  <h4 class="font-semibold text-green-800 dark:text-green-300 mb-3 text-base">
                    {{ t('docs.sections.basicUsage.commonConfig') }}
                  </h4>
                  <div class="grid md:grid-cols-2 gap-4 text-sm">
                    <div class="p-4 bg-emerald-50/80 dark:bg-emerald-900/40 backdrop-blur-sm border border-emerald-200/50 dark:border-emerald-800/50 rounded-xl transition-colors duration-300">
                      <div class="flex items-start gap-3">
                        <div class="w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0" />
                        <div>
          ...
          <div
            id="coreComponents"
            class="mt-8 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 shadow-xl border border-gray-200/50 dark:border-gray-700/50 transition-colors duration-300"
          >
            <h3 class="flex items-center gap-3 text-lg font-semibold text-gray-900 dark:text-white mb-6 transition-colors duration-300">
          ...
          <div
            id="beautifulApi"
            class="mt-8 rounded-2xl bg-gradient-to-br from-purple-50/80 to-blue-50/80 dark:from-purple-900/40 dark:to-blue-900/40 backdrop-blur-sm p-6 shadow-xl border border-purple-200/50 dark:border-purple-800/50 transition-colors duration-300"
          >
            ...
            <div class="grid md:grid-cols-2 gap-6 text-sm">
              <!-- 基础属性 -->
              <div class="space-y-4">
                <h4 class="font-semibold text-purple-800 dark:text-purple-300 text-base">
                  {{ t('docs.sections.vueMathjaxBeautifulApi.basicProps') }}
                </h4>
                <div class="space-y-3">
                  <div class="border-l-4 border-purple-500 pl-4 py-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-r-lg">
                    ...
                    <div class="text-gray-600 dark:text-gray-400 text-xs mt-1">
                      {{ t('docs.sections.vueMathjaxBeautifulApi.props.modelValue') }}
                    </div>
                  </div>
                  <div class="border-l-4 border-blue-500 pl-4 py-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-r-lg">
                    ...
                    <div class="text-gray-600 dark:text-gray-400 text-xs mt-1">
                      {{ t('docs.sections.vueMathjaxBeautifulApi.props.title') }}
                    </div>
                  </div>
                  <div class="border-l-4 border-green-500 pl-4 py-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-r-lg">
                    ...
                    <div class="text-gray-600 dark:text-gray-400 text-xs mt-1">
                      {{ t('docs.sections.vueMathjaxBeautifulApi.props.subtitle') }}
                    </div>
                  </div>
                  <div class="border-l-4 border-orange-500 pl-4 py-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-r-lg">
                    ...
                    <div class="text-gray-600 dark:text-gray-400 text-xs mt-1">
                      {{ t('docs.sections.vueMathjaxBeautifulApi.props.placeholder') }}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="space-y-4">
                <h4 class="font-semibold text-purple-800 dark:text-purple-300 text-base">
                  {{ t('docs.sections.vueMathjaxBeautifulApi.behaviorProps') }}
                </h4>
                <div class="space-y-3">
                  <div class="border-l-4 border-red-500 pl-4 py-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-r-lg">
                    ...
                    <div class="text-gray-600 dark:text-gray-400 text-xs mt-1">
                      {{ t('docs.sections.vueMathjaxBeautifulApi.props.inlineMode') }}
                    </div>
                  </div>
                  <div class="border-l-4 border-indigo-500 pl-4 py-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-r-lg">
                    ...
                    <div class="text-gray-600 dark:text-gray-400 text-xs mt-1">
                      {{ t('docs.sections.vueMathjaxBeautifulApi.props.existingLatex') }}
                    </div>
                  </div>
                  <div class="border-l-4 border-pink-500 pl-4 py-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-r-lg">
                    ...
                    <div class="text-gray-600 dark:text-gray-400 text-xs mt-1">
                      {{ t('docs.sections.vueMathjaxBeautifulApi.props.showThemeToggle') }}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="mt-8 pt-6 border-t border-purple-200/50 dark:border-purple-700/50">
              <h4 class="font-semibold text-purple-800 dark:text-purple-300 mb-4 text-base">
                {{ t('docs.sections.vueMathjaxBeautifulApi.events') }}
              </h4>
              <div class="grid md:grid-cols-2 gap-4 text-sm">
                <div class="border-l-4 border-green-500 pl-4 py-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-r-lg">
                  <div class="font-mono font-semibold text-gray-900 dark:text-white">
                  ...
                  <div class="text-gray-600 dark:text-gray-400 text-xs mt-1">
                    {{ t('docs.sections.vueMathjaxBeautifulApi.eventDesc.insert') }}
                  </div>
                </div>
                <div class="border-l-4 border-red-500 pl-4 py-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-r-lg">
                  <div class="font-mono font-semibold text-gray-900 dark:text-white">
                  ...
                  <div class="text-gray-600 dark:text-gray-400 text-xs mt-1">
                    {{ t('docs.sections.vueMathjaxBeautifulApi.eventDesc.cancel') }}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div
            id="advancedFeatures"
            class="mt-8 rounded-2xl bg-gradient-to-br from-cyan-50/80 to-blue-50/80 dark:from-cyan-900/40 dark:to-blue-900/40 backdrop-blur-sm p-6 shadow-xl border border-cyan-200/50 dark:border-cyan-800/50 transition-colors duration-300"
          >
            <h3 class="flex items-center gap-3 text-lg font-semibold text-cyan-900 dark:text-cyan-200 mb-6 transition-colors duration-300">
              <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-500 to-blue-500 text-white shadow-sm">
                <ZapIcon class="h-4 w-4" />
              </div>
              {{ t('docs.sections.advancedFeatures.title') }}
            </h3>
            
            <div class="grid md:grid-cols-2 gap-6">
              <!-- 主题系统 -->
              <div class="space-y-4">
                <h4 class="font-semibold text-cyan-800 dark:text-cyan-300 text-base">
                  {{ t('docs.sections.advancedFeatures.themeSystem') }}
                </h4>
              ...
              <div class="space-y-4">
                <h4 class="font-semibold text-cyan-800 dark:text-cyan-300 text-base">
                  {{ t('docs.sections.advancedFeatures.mobileOptimization') }}
                </h4>
                <div class="bg-gray-900/90 dark:bg-gray-950/90 backdrop-blur-sm text-gray-100 dark:text-gray-200 p-4 rounded-xl font-mono text-sm border border-gray-700/50">
                  <div class="text-purple-400">
                    import { useMobile, useMobileOptimization } from 'vue-mathjax-beautiful'
                  </div>
                  <br>
                  <div class="text-gray-400">
                    // 移动端检测
                  ...
                  <div class="text-white">
                    const { responsiveStyles } = useMobileOptimization()
                  </div>
                </div>
              </div>
              ...
              <div class="space-y-4">
                <h4 class="font-semibold text-cyan-800 dark:text-cyan-300 text-base">
                  {{ t('docs.sections.advancedFeatures.lazyLoading') }}
                </h4>
                <div class="bg-gray-900/90 dark:bg-gray-950/90 backdrop-blur-sm text-gray-100 dark:text-gray-200 p-4 rounded-xl font-mono text-sm border border-gray-700/50">
                  <div class="text-purple-400">
                    import { lazyLoadMathJax, preloadMathJax } from 'vue-mathjax-beautiful'
                  </div>
                  <br>
                  <div class="text-gray-400">
                    // 按需加载
              ...
              <div class="space-y-4">
                <h4 class="font-semibold text-cyan-800 dark:text-cyan-300 text-base">
                  {{ t('docs.sections.advancedFeatures.caching') }}
                </h4>
                <div class="bg-gray-900/90 dark:bg-gray-950/90 backdrop-blur-sm text-gray-100 dark:text-gray-200 p-4 rounded-xl font-mono text-sm border border-gray-700/50">
                  <div class="text-purple-400">
                    import { LRUCache, FormulaCache } from 'vue-mathjax-beautiful'
                  </div>
                  <br>
                  <div class="text-gray-400">
                    // LRU 缓存
          ...
          <div
            id="examples"
            class="mt-8 rounded-2xl bg-gradient-to-br from-amber-50/80 to-orange-50/80 dark:from-amber-900/40 dark:to-orange-900/40 backdrop-blur-sm p-6 shadow-xl border border-amber-200/50 dark:border-amber-800/50 transition-colors duration-300"
          >
            ...
            <div class="grid md:grid-cols-2 gap-6">
              <div class="space-y-4">
                <h4 class="font-semibold text-amber-800 dark:text-amber-300">
                  {{ t('docs.sections.examples.commonUsage') }}
                </h4>
                <div class="bg-gray-900/90 dark:bg-gray-950/90 backdrop-blur-sm text-gray-100 dark:text-gray-200 p-4 rounded-xl font-mono text-sm border border-gray-700/50">
                  <div class="text-green-400">
                    // {{ t('docs.sections.examples.inlineUsage') }}
                  </div>
                  <div>&lt;VueMathjaxBeautiful :inline-mode="true" /&gt;</div>
                  <br>
                  <div class="text-green-400">
                    // {{ t('docs.sections.examples.dialogUsage') }}
                  </div>
              ...
              <div class="space-y-4">
                <h4 class="font-semibold text-amber-800 dark:text-amber-300">
                  {{ t('docs.sections.examples.bestPractices') }}
                </h4>
                <ul class="space-y-2 text-sm text-amber-700 dark:text-amber-300">
                  <li class="flex items-start gap-2">
                    <div class="w-1.5 h-1.5 bg-amber-500 rounded-full mt-2 flex-shrink-0" />
...
const tocItems = ref([
  ...
  { id: 'advancedFeatures', icon: ZapIcon },
